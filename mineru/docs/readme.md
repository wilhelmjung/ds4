...
> MinerU 相关文档：
> [设计](mu-design.md)，[架构](mu-architecture.md)，[Metal 化设计](mu-metal-design.md)，[Metal 执行计划](mu-metal-plan.md)，[性能优化方案](mu-performance-optimization.md)，[性能优化执行计划](mu-metal-perf-plan.md)，[Metal kernel 优化计划](mu-metal-kernel-optimization-plan.md)，[计划](mu-plan.md)，[性能测试报告](mu-performance-report.md)，[MU Skills](mu-skills.md)。
